...
test("1,1000,10001,2000000,2 = 1003", () => { expect(calc("1,1000,10001,2000000,2")).toBe(1003);});
test("//something\n1,1\n1something1something1 = 5" , ()  => { expect(calc("//something\n1,1\n1something1something1 ")).toBe(5);});
